...
/**
 * Operation that updates a {@link Ruleset} into a new draft version
 */
@Service
@Slf4j
@RequiredArgsConstructor
public class UpdateRulesetAsNewDraftConsumer implements Consumer<Ruleset> {
    ...
    public void accept(Ruleset input) {
        ...
        log.info(
                "Message=Making a new draft version of the ruleset;RulesetId={};RulesetReference={};RulesetVersion={};",
