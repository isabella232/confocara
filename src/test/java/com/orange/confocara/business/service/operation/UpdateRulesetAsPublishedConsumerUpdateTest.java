...
/**
 * see {@link UpdateRulesetAsPublishedConsumer#accept(Ruleset)}
 */
public class UpdateRulesetAsPublishedConsumerUpdateTest {
    ...
    public void shouldDelegateUpdatingAndSaving() {
        ...
        subject = new UpdateRulesetAsPublishedConsumer(repository);

        // When
        subject.accept(mock(Ruleset.class));

        // Then
        verify(input).markAsPublished();
    }
}