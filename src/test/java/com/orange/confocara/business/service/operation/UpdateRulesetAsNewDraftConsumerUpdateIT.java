...
public class UpdateRulesetAsNewDraftConsumerUpdateIT {
    ...
    public void shouldDelegateUpdatingAndSaving() {
        ...
        assertThat(actualRuleset.getVersion()).isEqualTo(originalVersion + 1);
        assertThat(actualRuleset.isPublished()).isEqualTo(false);
    }
