...
import com.orange.confocara.presentation.view.question.create.QuestionAddViewControllerViewQuestionIT.QuestionAddViewControllerEditQuestionITConfig;
...
/**
 * see {@link QuestionAddViewController#viewQuestion(Principal, Model, String)}
 */
@RunWith(SpringJUnit4ClassRunner.class)
@WebAppConfiguration
@ContextConfiguration(classes = {
        ConfOcaraSpringApplication.class, QuestionAddViewControllerEditQuestionITConfig.class})
@DirtiesContext(classMode = ClassMode.AFTER_CLASS)
@Slf4j
public class QuestionAddViewControllerViewQuestionIT {
    ...
    private final String url = "/questions/add";
    ...
    static final class QuestionAddViewControllerEditQuestionITConfig {
        ...
        public QuestionAddService questionAddService() {
            ...
            doAnswer(QuestionAddViewControllerEditQuestionITConfig::answer)
                    .when(mock)
                    .loadQuestion(Mockito.anyString(), Mockito.any(Principal.class), Mockito.any(Model.class));
            return mock;
        }
    }
}
