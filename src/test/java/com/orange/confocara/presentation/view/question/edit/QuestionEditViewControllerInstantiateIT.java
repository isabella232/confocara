...
/**
 * @see QuestionEditViewController
 */
...
@ActiveProfiles("test")
@Slf4j
public class QuestionEditViewControllerInstantiateIT {
    ...
    public void shouldProvideControllerWhenServletContextIsGiven() {
        ...
        Assertions.assertThat(wac.getBean("questionEditViewController")).isNotNull();
    }
}