...
/**
 * @see CompositePublishingStrategy#check(QuestionnaireObject)
 */
public class CompositePublishingStrategyCheckTest {
    ...
    @Test
    public void shouldReturnTrueWhenSubEquipmentsHaveOnlyOneQuestionnaire() {
    ...
    @Test
    public void shouldReturnFalseWhenSubEquipmentsHaveMultipleQuestionnaires() {
