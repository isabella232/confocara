...
public class QuestionnaireRepositoryFindAllQuestionnaireQuestionIT {
    ...
    @Test
    public void shouldReturnEmptyQuestionListWhenDBContains1QuestionnaireWithOQuestion() {
        List<QuestionnaireQuestionsDto> allQuestionnaireQuestionDto = questionnaireDtoRepository.findAllQuestionnaireQuestionDto();
        Assert.assertNotNull(allQuestionnaireQuestionDto);
        Assert.assertTrue(allQuestionnaireQuestionDto.isEmpty());
    }

    @Test
    public void shouldReturn1QuestionWhenDBContains1QuestionnaireWith1Question() {
        ...
        List<QuestionnaireQuestionsDto> allQuestionnaireQuestionDto = questionnaireDtoRepository.findAllQuestionnaireQuestionDto();
        Assert.assertNotNull(allQuestionnaireQuestionDto);
        Assert.assertFalse(allQuestionnaireQuestionDto.isEmpty());
        Assert.assertTrue(allQuestionnaireQuestionDto.size() == 1);
        Assert.assertNotNull(allQuestionnaireQuestionDto.get(0).getQuestionsNb());
        Assert.assertTrue(allQuestionnaireQuestionDto.get(0).getQuestionsNb() == 1);
    }
