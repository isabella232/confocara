...
@ActiveProfiles("test")
@Slf4j
public class QuestionAddViewControllerInstantiateTest {
    ...
    public void shouldProvideControllerWhenServletContextIsGiven() {
        ...
        Assertions.assertThat(wac.getBean("questionAddViewController")).isNotNull();
    }
}